...
@parent
{!! HTML::script( URL::asset('js/admin/anon-screen-carousel-details.js') ) !!}
@stop
...
<script>
    jQuery(document).ready(function () {
        siteObjJs.admin.anonScreenCarouselDetailsJs.init();
...
@include('admin::anon-screen-carousel-details.create')
@endif
...
<div class="portlet light col-lg-12">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-blue-sharp bold uppercase">View Anon Screen Carousel Details</span>
        </div>
        @if(!empty(Auth::user()->hasAdd))
        <div class="actions">
            <a href="javascript:;" class="btn blue btn-add-big btn-expand-form"><i class="fa fa-plus"></i><span class="hidden-480">Add Anon Screen Carousel Details </span></a>
        </div>
        @endif
    </div>
    <div class="portlet-body">
        <div class="table-container">
            ...
            <table class="table table-striped table-bordered table-hover" id="AnonScreenCarouselDetailsList">
                <thead>
                    <tr role="row" class="heading">
                        <th>#</th>
                        <th width="10%">Anon Screen ID</th>
                        <th width="10%">Title</th>
                        <th width="25%">Description</th>
                        <th width="5%">Media Type</th>
                        <th width="20%">Media Link</th>
                        <th width="5%">Shape</th>
                        <th width="5%">Rank</th>
