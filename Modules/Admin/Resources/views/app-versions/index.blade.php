...
@parent
{!! HTML::script( URL::asset('js/admin/app-versions.js') ) !!}
@stop
...
<script>
    jQuery(document).ready(function () {
        siteObjJs.admin.appVersionsJs.init();
...
<div class="portlet light col-lg-12">
    ...
    <div class="portlet-body">
        <div class="table-container">
            ...
            <table class="table table-striped table-bordered table-hover" id="app-versions-table">
                <thead>
                    <tr role="row" class="heading">
                        <th width='1%'>#</th>
                        <th>{!! trans('admin::controller/faq-category.category-id') !!}</th>
                        <th width='54%'>App Version</th>
                        <th width='10%'>Is Hungama Enabled</th>
                        <th width='10%'>Is ViMTV SDK Enabled</th>
