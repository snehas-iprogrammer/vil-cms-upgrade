<div class="portlet box yellow-gold edit-form-main">
    ...
    <div class="portlet-body form">
        {!! Form::model($livemusic, ['route' => ['admin.livemusic.update', $livemusic->id], 'method' => 'put', 'class' => 'form-horizontal panel livemusic-form','id'=>'edit-livemusic', 'msg' => trans('admin::messages.updated', ['name' => trans('admin::controller/banner.banner') ]) ]) !!}
        @include('admin::livemusic.form',['action'=>'update'])
