<div class="portlet box blue add-form-main">
    <div class="portlet-title togglelable">
        <div class="caption">
            <i class="fa fa-plus"></i>Live Music Banner 
        </div>
        <div class="tools">
    ...
    <div class="portlet-body form display-hide">
        {!! Form::open(['route' => ['admin.livemusic.store'], 'method' => 'post', 'files' => 'true', 'class' => 'form-horizontal livemusic-form',  'id' => 'create-livemusic']) !!}
        @include('admin::livemusic.form',['action'=>'create'])
