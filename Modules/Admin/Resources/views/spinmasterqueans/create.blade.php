<div class="portlet box blue add-form-main">
    <div class="portlet-title togglelable">
        <div class="caption">
            <i class="fa fa-plus"></i>STW Question Answers
        </div>
        <div class="tools">
    ...
    <div class="portlet-body form display-hide">
        {!! Form::open(['route' => ['admin.spinmasterqueans.store'], 'method' => 'post', 'files' => 'true', 'class' => 'form-horizontal spinmasterqueans-form',  'id' => 'create-spinmasterqueans']) !!}
        @include('admin::spinmasterqueans.form',['action'=>'create'])
