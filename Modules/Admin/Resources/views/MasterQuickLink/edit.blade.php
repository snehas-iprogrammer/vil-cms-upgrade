<div class="portlet box yellow-gold edit-form-main">
    ...
    <div class="portlet-body form">
        {!! Form::model($masterquicklink, ['route' => ['admin.masterquicklink.update', $masterquicklink->id], 'method' => 'put', 'class' => 'form-horizontal panel masterquicklink-form','id'=>'edit-masterquicklink', 'msg' => trans('admin::messages.updated', ['name' => "Master Quick Link" ]) ]) !!}
        @include('admin::MasterQuickLink.form',['action'=>'update'])
