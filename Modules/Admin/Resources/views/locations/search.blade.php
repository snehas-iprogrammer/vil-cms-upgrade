<tr role="row" class="filter">
    ...
    <td>
        <div id="city-drop-down-search">
            {!!  Form::select('city_id', ['' => 'Select City'] +$cityList, null, ['class'=>'form-control form-filter']) !!}
        </div>

    </td>
    <td>
        {!! Form::text('location', null, ['class'=>'form-control form-filter']) !!}
    </td>
    <td>
