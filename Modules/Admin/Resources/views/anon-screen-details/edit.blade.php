<div class="portlet box yellow-gold edit-form-main">
    ...
    <div class="portlet-body form">
        {!! Form::model($anonScreenDetails, ['route' => ['admin.anon-screen-details.update', $anonScreenDetails->id], 'method' => 'put', 'class' => 'form-horizontal panel anon-screen-details-form','id'=>'edit-anon-screen-details', 'msg' => trans('admin::messages.updated',['name'=>'Anon Screen Details']) ]) !!}
