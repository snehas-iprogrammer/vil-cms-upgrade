<div class="portlet box yellow-gold edit-form-main">
    ...
    <div class="portlet-body form">
        {!! Form::model($appQuickLinks, ['route' => ['admin.appquick-links.update', $appQuickLinks->id], 'method' => 'put', 'class' => 'form-horizontal panel banner-form','id'=>'edit-appquick-links', 'msg' => trans('admin::messages.updated', ['name' => 'Quick Link' ]) ]) !!}
        @include('admin::appquick-links.form',['action'=>'update'])
