<div class="portlet box yellow-gold edit-form-main">
    ...
    <div class="portlet-body form">
        {!! Form::model($socialbanner, ['route' => ['admin.socialgamingbanner.update', $socialbanner->id], 'method' => 'put', 'class' => 'form-horizontal panel banner-form','id'=>'edit-socialgamingbanner', 'msg' => trans('admin::messages.updated', ['name' => trans('admin::controller/banner.banner') ]) ]) !!}
        @include('admin::socialgaming-banners.form',['action'=>'update'])
