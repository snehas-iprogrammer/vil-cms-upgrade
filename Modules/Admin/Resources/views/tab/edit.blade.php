<div class="portlet box yellow-gold edit-form-main">
    <div class="portlet-title togglelable">
        <div class="caption">
            <i class="fa fa-pencil"></i>{!! trans('admin::messages.edit-name', ['name' => 'Tab' ]) !!}
        </div>
        <div class="tools">
    ...
    <div class="portlet-body form">
        {!! Form::model($Tab, ['route' => ['admin.tab.update', $Tab->id], 'method' => 'put', 'class' => 'form-horizontal panel tab-form','id'=>'edit-tab', 'msg' => trans('admin::messages.updated',['name'=>'Name']) ]) !!}
