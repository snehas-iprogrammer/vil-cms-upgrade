<div class="portlet box yellow-gold edit-form-main">
    ...
    <div class="portlet-body form">
        {!! Form::model($videos, ['route' => ['admin.videos.update', $videos->id], 'method' => 'put', 'class' => 'form-horizontal panel videos-form','id'=>'edit-videos', 'msg' => trans('admin::messages.updated', ['name' => 'Video' ]) ]) !!}
        @include('admin::videos.form',['action'=>'update'])
