<div class="form-body">
    ...
    <div class="form-group">
        <label class="col-md-3 control-label">MRP Sequence Data<span class="required" aria-required="true">*</span></label>
        <div class="col-md-8">
            {!! Form::textarea('mrp_sequence_data', null, ['minlength'=>2, 'rows' => 5, 'class'=>'form-control', 'id'=>'mrp_sequence_data', 'data-rule-required'=>'true', 'data-msg-required'=>trans('admin::messages.required-enter', ['name' => 'MRP Sequence Data']), 'data-msg-minlength'=>trans('admin::messages.error-minlength', ['name' => 'MRP Sequence Data']) ])!!}
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label class="control-label col-md-3">Promo Display <span class="required" aria-required="true">*</span></label>
        <div class="col-md-8">
            <div class="radio-list">
                <label class="radio-inline">{!! Form::radio('promo_display', '1') !!} Display Promo</label>
                <label class="radio-inline">{!! Form::radio('promo_display', '0',true) !!} Hide Promo</label>
            </div>
        </div>
     </div>
    <div class="form-group">
