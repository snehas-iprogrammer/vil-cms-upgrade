<div class="portlet box yellow-gold edit-form-main">
    ...
    <div class="portlet-body form">
        {!! Form::model($rechargeOffers, ['route' => ['admin.recharge-offers.update', $rechargeOffers->id], 'method' => 'put', 'class' => 'form-horizontal panel recharge-offers-form','id'=>'edit-recharge-offers', 'msg' => trans('admin::messages.updated',['name'=>'Recharge Offer']) ]) !!}
