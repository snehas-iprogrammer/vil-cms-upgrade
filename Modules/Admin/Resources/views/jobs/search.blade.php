...
<td></td>
<td>{!! Form::text('name', null, ['class'=>'form-control form-filter input-sm form-filter input-sm']) !!}</td>
<td>{!! Form::text('label', null, ['class'=>'form-control form-filter input-sm form-filter input-sm']) !!}</td>
