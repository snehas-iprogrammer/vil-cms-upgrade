<div class="portlet box yellow-gold edit-form-main">
    ...
    <div class="portlet-body form">
        {!! Form::model($jobs, ['route' => ['admin.jobs.update', $jobs->id], 'method' => 'put', 'class' => 'form-horizontal panel banner-form','id'=>'edit-jobs', 'msg' => trans('admin::messages.updated', ['name' => trans('admin::controller/banner.banner') ]) ]) !!}
        @include('admin::jobs.form',['action'=>'update'])
