<div class="portlet box blue add-form-main">
    <div class="portlet-title togglelable">
        <div class="caption">
            <i class="fa fa-plus"></i>Add New Jobs Details
        </div>
        <div class="tools">
    ...
    <div class="portlet-body form display-hide">
        {!! Form::open(['route' => ['admin.jobs.store'], 'method' => 'post', 'files' => 'true', 'class' => 'form-horizontal banner-form',  'id' => 'create-jobs', 'msg' => trans('admin::messages.added',['name'=>trans('admin::controller/banner.banner')])]) !!}
        @include('admin::jobs.form',['action'=>'create'])
