<div class="portlet box yellow-gold edit-form-main">
    ...
    <div class="portlet-body form">
        {!! Form::model($quickRechargeDetails, ['route' => ['admin.quick-recharge-details.update', $quickRechargeDetails->id], 'method' => 'put', 'class' => 'form-horizontal panel recharge-offers-form','id'=>'edit-quick-recharge-details', 'msg' => trans('admin::messages.updated',['name'=>'Quick Recharge Details']) ]) !!}
