<div class="portlet box blue add-form-main">
    <div class="portlet-title togglelable">
        <div class="caption">
            <i class="fa fa-plus"></i>{!! trans('admin::messages.add-name',['name'=>'Silent OTA']) !!} 
        </div>
        <div class="tools">
    ...
    <div class="portlet-body form display-hide">
        {!! Form::open(['route' => ['admin.silent-otas.store'], 'method' => 'post', 'class' => 'form-horizontal config-category-form',  'id' => 'create-silent-otas', 'msg' => trans('admin::messages.added',['name'=> 'Silent OTA']) ]) !!}
