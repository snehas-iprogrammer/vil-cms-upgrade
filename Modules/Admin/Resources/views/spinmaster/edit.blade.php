<div class="portlet box yellow-gold edit-form-main">
    ...
    <div class="portlet-body form">
        {!! Form::model($SpinMaster, ['route' => ['admin.spinmaster.update', $SpinMaster->id], 'method' => 'put', 'class' => 'form-horizontal panel spinmaster-form','id'=>'edit-spinmaster', 'msg' => trans('admin::messages.updated', ['name' => trans('admin::controller/banner.banner') ]) ]) !!}
        @include('admin::spinmaster.form',['action'=>'update'])
