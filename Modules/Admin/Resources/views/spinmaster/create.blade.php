<div class="portlet box blue add-form-main">
    <div class="portlet-title togglelable">
        <div class="caption">
            <i class="fa fa-plus"></i>Spin Master 
        </div>
        <div class="tools">
    ...
    <div class="portlet-body form display-hide">
        {!! Form::open(['route' => ['admin.spinmaster.store'], 'method' => 'post', 'files' => 'true', 'class' => 'form-horizontal spinmaster-form',  'id' => 'create-spinmaster']) !!}
        @include('admin::spinmaster.form',['action'=>'create'])
