<div class="portlet box blue add-form-main">
    <div class="portlet-title togglelable">
        <div class="caption">
            <i class="fa fa-plus"></i>{!! trans('admin::messages.add-name',['name'=>trans('admin::controller/faq.faq')]) !!}
        </div>
        <div class="tools">
    ...
    <div class="portlet-body form display-hide">
        {!! Form::open(['route' => ['admin.faqs.store'], 'method' => 'post', 'class' => 'form-horizontal faq-form',  'id' => 'create-faq', 'msg' => trans('admin::messages.added',['name'=>trans('admin::controller/faq.faq')])]) !!}
