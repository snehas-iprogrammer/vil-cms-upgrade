...
<td>{!! Form::select('login_type',[''=> 'Select'] +  $loginTypeList, null,['class'=>'select2me form-control form-filter input-sm']) !!}</td>                        
<td>{!! Form::select('brand',[''=> 'Select'] +  $brandList, null,['class'=>'select2me form-control form-filter input-sm']) !!}</td> 
