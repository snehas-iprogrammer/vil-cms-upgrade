...
class MasterQuickLinkDeleteRequest extends Request
{
    ...
    {
        return [
            'id.required' => trans('admin::messages.required-select', ['name' => trans('admin::controller/masterquicklink.id')]),
            'id.numeric' => trans('admin::messages.error-numeric-id', ['name' => trans('admin::controller/masterquicklink.id')]),
        ];
    }
