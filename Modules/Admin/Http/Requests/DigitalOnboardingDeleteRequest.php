...
class DigitalOnboardingDeleteRequest extends Request
{
    ...
    {
        return [
            'ids.required' => trans('admin::messages.required-select', ['name' => 'Recharge Offer']),
            'ids.numeric' => trans('admin::messages.error-numeric-id', ['name' => 'Recharge Offer']),
        ];
    }
