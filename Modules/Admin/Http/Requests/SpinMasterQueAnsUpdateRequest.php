...
class SpinMasterQueAnsUpdateRequest extends Request
{
    ...
    {
        return [
            'question.required' => trans('admin::messages.required-enter', ['name' => 'question']),
            'answer1.required' => trans('admin::messages.required-enter', ['name' => 'answer1']),
            'answer2.required' => trans('admin::messages.required-enter', ['name' => 'answer2']),
            'answer3.required' => trans('admin::messages.required-enter', ['name' => 'answer3']),
            'answer4.required' => trans('admin::messages.required-enter', ['name' => 'answer4']),
            'correct_answer.required' => trans('admin::messages.required-enter', ['correct_answer' => 'rank']),
