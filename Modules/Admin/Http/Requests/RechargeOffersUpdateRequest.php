...
class RechargeOffersUpdateRequest extends Request
{
    ...
    {
        $this->sanitize();
        $id = $this->recharge_offers->id;
        return [
            'segment_name' => 'required|max:255|unique:recharge_offers,segment_name,' . $id, 
            'route_name' => 'required|max:255|unique:recharge_offers,route_name,' . $id,
