...
class AppVersionsDeleteRequest extends Request
{
    ...
    {
        return [
            'ids.required' => trans('admin::messages.required-select', ['name' => 'App version']),
            'ids.numeric' => trans('admin::messages.error-numeric-id', ['name' => 'App version']),
        ];
    }
