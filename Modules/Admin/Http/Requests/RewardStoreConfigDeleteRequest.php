...
class RewardStoreConfigDeleteRequest extends Request
{
    ...
    {
        return [
            'ids.required' => trans('admin::messages.required-select', ['name' => 'Dashboard Config']),
            'ids.numeric' => trans('admin::messages.error-numeric-id', ['name' => 'Dashboard Config']),
        ];
    }
