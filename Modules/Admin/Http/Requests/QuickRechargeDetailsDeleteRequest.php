...
class QuickRechargeDetailsDeleteRequest extends Request
{
    ...
    {
        return [
            'ids.required' => trans('admin::messages.required-select', ['name' => 'Quick Recharge']),
            'ids.numeric' => trans('admin::messages.error-numeric-id', ['name' => 'Quick Recharge']),
        ];
    }
