...
class AnonScreenCarouselDetailsDeleteRequest extends Request
{
    ...
    {
        return [
            'ids.required' => trans('admin::messages.required-select', ['name' => trans('admin::controller/banner.id')]),
            'ids.numeric' => trans('admin::messages.error-numeric-id', ['name' => trans('admin::controller/banner.id')]),
        ];
    }
