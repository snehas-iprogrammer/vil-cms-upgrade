...
// we merge default config and user config file
    ...
    var root_folder_path = $('#root_folder_path').val();
    var user_id = $('#logged_user_id').val();
    config.options.fileRoot = root_folder_path + user_id + '/';
...
// through culture var or from URL
    ...
    // Just display site name instead of 'Current Folder' text
    lg.current_folder   =   location.protocol+'//'+document.location.hostname;
...
//					$('#uploader h1').text(lg.current_folder + displayPath(rootpath)).attr("title", displayPath(rootpath, false)).attr('data-path', rootpath);
                        ...
                        $('#uploader h1').text(lg.current_folder + displayPath(current_path)).attr("title", displayPath(current_path, false)).attr('data-path', current_path);
                        isDeleted = true;
