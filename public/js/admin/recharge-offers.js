siteObjJs.admin.rechargeOffersJs = function () {
...
// Initialize all the page-specific event listeners here.
    ...
    var initializeListener = function () {
        ...
        $('body').on('click', '.delete', function (e) {
            e.preventDefault();
            var rechargeOfferId = $(this).attr('id');
            bootbox.confirm({
            ...
            function handleGroupAction(grid) {
                ...
                var actionUrl = 'recharge-offers/' + rechargeOfferId;
                jQuery.ajax({
                    url: actionUrl,
                    cache: false,
                    data: {
    ...
    var fetchDataForEdit = function () {
        $('.portlet-body').on('click', '.edit-form-link', function () {
            var rechargeOfferId = $(this).attr("id");
            var actionUrl = 'recharge-offers/' + rechargeOfferId + '/edit';
            $.ajax({
                url: actionUrl,
                cache: false,
                dataType: "json",
                ...
                success: function (data)
                {
                    ...
                    siteObjJs.validation.formValidateInit('#edit-recharge-offers', handleAjaxRequest);
                },
        ...
        grid.init({
            ...
            dataTable: {
                ...
                "columns": [
                    ...
                    {data: 'mrp_sequence_data', name: 'mrp_sequence_data'},
    ...
    return {
        ...
        init: function () {
            ...
            siteObjJs.validation.formValidateInit('#create-recharge-offers', handleAjaxRequest);
        }
