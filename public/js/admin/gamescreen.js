siteObjJs.admin.gamescreenJs = function () {
    ...
    var initializeListener = function () {
        ...
        $('body').on('click', '.delete', function (e) {
            ...
            function handleGroupAction(grid) {
                ...
                var actionUrl = 'gamescreen/' + silentOtasId;
                jQuery.ajax({
                    url: actionUrl,
                    cache: false,
                    data: {
        ...
        $('#gamescreen-table').on('click', '.filter-cancel', function (e) {
    ...
    var fetchDataForEdit = function () {
        $('.portlet-body').on('click', '.edit-form-link', function () {
            var id = $(this).attr("id");
            var actionUrl = 'gamescreen/' + id + '/edit';
            $.ajax({
                url: actionUrl,
                cache: false,
                dataType: "json",
                ...
                success: function (data)
                {
                    ...
                    siteObjJs.validation.formValidateInit('#edit-gamescreen', handleAjaxRequest);
                },
        ...
        grid.init({
            ...
            dataTable: {
                ...
                "columns": [
                    ...
                    {data: 'section_name', name: 'section_name', orderable: true},
    ...
    return {
        ...
        init: function () {
            ...
            siteObjJs.validation.formValidateInit('#create-gamescreen', handleAjaxRequest);
        }
