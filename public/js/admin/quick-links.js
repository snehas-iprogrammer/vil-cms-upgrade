siteObjJs.admin.quickLinksJs = function () {
    ...
    var fetchDataForEdit = function () {
        $('.portlet-body').on('click', '.edit-form-link', function () {
            var id = $(this).attr("id");
            var actionUrl = 'quick-links/' + id + '/edit';
            $.ajax({
                url: actionUrl,
                cache: false,
                dataType: "json",
                ...
                success: function (data)
                {
                    ...
                    siteObjJs.validation.formValidateInit('#edit-quick-links', handleAjaxRequest);
                },
    ...
    var handleTable = function () {
        ...
        grid.init({
            ...
            dataTable: {
                ...
                "columns": [
                    ...
                    {data: 'persona', name: 'persona', orderable: false},                    
                    {data: 'login', name: 'login', orderable: false},
                    {data: 'plan', name: 'plan', orderable: false},
                    {data: 'red_hierarchy', name: 'red_hierarchy', orderable: false},
                    {data: 'socid', name: 'socid', orderable: false},
        ...
        function handleGroupAction(grid, data) {
            ...
            var actionUrl = 'quick-links/group-action';
    ...
    return {
        ...
        init: function () {
            ...
            siteObjJs.validation.formValidateInit('#create-quick-links', handleAjaxRequest);
        }
