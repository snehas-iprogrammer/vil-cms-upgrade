siteObjJs.admin.segmentDetailsJs = function () {
...
// Initialize all the page-specific event listeners here.
    ...
    var initializeListener = function () {
        ...
        $('body').on('click', '.delete', function (e) {
            ...
            function handleGroupAction(grid) {
                ...
                var actionUrl = 'segment-details/' + segmentDetailsId;
                jQuery.ajax({
                    url: actionUrl,
                    cache: false,
                    data: {
    ...
    var fetchDataForEdit = function () {
        $('.portlet-body').on('click', '.edit-form-link', function () {
            var segmentDetailsId = $(this).attr("id");
            var actionUrl = 'segment-details/' + segmentDetailsId + '/edit';
            $.ajax({
                url: actionUrl,
                cache: false,
                dataType: "json",
                ...
                success: function (data)
                {
                    ...
                    siteObjJs.validation.formValidateInit('#edit-segment-details', handleAjaxRequest);
                },
    ...
    return {
        ...
        init: function () {
            ...
            siteObjJs.validation.formValidateInit('#create-segment-details', handleAjaxRequest);
        }
