siteObjJs.admin.anonScreenDetailsJs = function () {
...
//            location.reload();
        ...
        $('body').on('click', '.delete', function (e) {
            e.preventDefault();
            var anonScreenDetailsId = $(this).attr('id');
            bootbox.confirm({
            ...
            function handleGroupAction(grid) {
                ...
                var actionUrl = 'anon-screen-details/' + anonScreenDetailsId;
                jQuery.ajax({
                    url: actionUrl,
                    cache: false,
                    data: {
    ...
    var fetchDataForEdit = function () {
        $('.portlet-body').on('click', '.edit-form-link', function () {
            var anonScreenDetailsId = $(this).attr("id");
            var actionUrl = 'anon-screen-details/' + anonScreenDetailsId + '/edit';
            $.ajax({
                url: actionUrl,
                cache: false,
                dataType: "json",
                ...
                success: function (data)
                {
                    ...
                    siteObjJs.validation.formValidateInit('#edit-anon-screen-details', handleAjaxRequest);
                },
        ...
        grid.init({
            ...
            dataTable: {
                ...
                "columns": [
                    ...
                    {data: 'screen_header', name: 'screen_header'},
                    {data: 'screen_title', name: 'screen_title'},
                    {data: 'screen_description', name: 'screen_description'},
                    {data: 'faqs_json', name: 'faqs_json'},
                    {data: 'mrps_json', name: 'mrps_json'},
    ...
    return {
        ...
        init: function () {
            ...
            siteObjJs.validation.formValidateInit('#create-anon-screen-details', handleAjaxRequest);
        }
