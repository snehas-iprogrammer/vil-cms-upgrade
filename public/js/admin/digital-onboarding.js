siteObjJs.admin.digitalOnboardingJs = function () {
...
// Initialize all the page-specific event listeners here.
    ...
    var initializeListener = function () {
        ...
        $('body').on('click', '.delete', function (e) {
            e.preventDefault();
            var segmentDetailsId = $(this).attr('id');
            bootbox.confirm({
            ...
            function handleGroupAction(grid) {
                ...
                var actionUrl = 'digital-onboarding/' + digitalOnboardingId;
                jQuery.ajax({
                    url: actionUrl,
                    cache: false,
                    data: {
    ...
    var fetchDataForEdit = function () {
        $('.portlet-body').on('click', '.edit-form-link', function () {
            var digitalOnboardingId = $(this).attr("id");
            var actionUrl = 'digital-onboarding/' + digitalOnboardingId + '/edit';
            $.ajax({
                url: actionUrl,
                cache: false,
                dataType: "json",
                ...
                success: function (data)
                {
                    ...
                    siteObjJs.validation.formValidateInit('#edit-digital-onboarding', handleAjaxRequest);
                },
        ...
        grid.init({
            ...
            dataTable: {
                ...
                "columns": [
                    ...
                    {data: 'prepaid_circles', name: 'prepaid_circles'},
                    {data: 'postpaid_circles', name: 'postpaid_circles'},
    ...
    return {
        ...
        init: function () {
            ...
            siteObjJs.validation.formValidateInit('#create-digital-onboarding', handleAjaxRequest);
        }
