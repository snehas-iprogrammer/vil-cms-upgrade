siteObjJs.admin.spinmasterqueansJs = function () {
    ...
    var initializeListener = function () {
        ...
        $('body').on("change", "#lob", function () {
         ...
         $('#spinmasterqueansList').on('click', '.filter-cancel', function (e) {
        });
    };
    ...
    var fetchDataForEdit = function () {
        $('.portlet-body').on('click', '.edit-form-link', function () {
            var id = $(this).attr("id");
            var actionUrl = 'spinmasterqueans/' + id + '/edit';
            $.ajax({
                url: actionUrl,
                cache: false,
                dataType: "json",
                ...
                success: function (data)
                {
                    ...
                    siteObjJs.validation.formValidateInit('#edit-spinmasterqueans', handleAjaxRequest);
                },
        ...
        grid.init({
            ...
            dataTable: {
                ...
                "columns": [
                    ...
                    {data: 'answer1', name: 'answer1', orderable: false},
                    {data: 'answer2', name: 'answer2', orderable: true},                  
                    {data: 'answer3', name: 'answer3', orderable: true},                   
                    {data: 'answer4', name: 'answer4', orderable: true},
                    {data: 'correct_answer', name: 'correct_answer', orderable: true},
...
//                ]// set first column as a default sort by asc
        ...
        function handleGroupAction(grid, data) {
            ...
            var actionUrl = 'spinmasterqueans/group-action';
    ...
    return {
        ...
        init: function () {
            ...
            siteObjJs.validation.formValidateInit('#create-spinmasterqueans', handleAjaxRequest);
        }
