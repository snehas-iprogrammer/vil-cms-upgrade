siteObjJs.admin.quickRechargeDetailsJs = function () {
...
// Initialize all the page-specific event listeners here.
    ...
    var initializeListener = function () {
        ...
        $('body').on('click', '.delete', function (e) {
            e.preventDefault();
            var quickRechargeDetailsId = $(this).attr('id');
            bootbox.confirm({
            ...
            function handleGroupAction(grid) {
                ...
                var actionUrl = 'quick-recharge-details/' + quickRechargeDetailsId;
                jQuery.ajax({
                    url: actionUrl,
                    cache: false,
                    data: {
    ...
    var fetchDataForEdit = function () {
        $('.portlet-body').on('click', '.edit-form-link', function () {
            var quickRechargeDetailsId = $(this).attr("id");
            var actionUrl = 'quick-recharge-details/' + quickRechargeDetailsId + '/edit';
            $.ajax({
                url: actionUrl,
                cache: false,
                dataType: "json",
                ...
                success: function (data)
                {
                    ...
                    siteObjJs.validation.formValidateInit('#edit-quick-recharge-details', handleAjaxRequest);
                },
    ...
    var handleTable = function () {
        ...
        grid = new Datatable();
        grid.init({
            src: $('#quick-recharge-details-table'),
            ...
            dataTable: {
                ...
                "columns": [
                    ...
                    {data: 'mrp', name: 'mrp'},
                    {data: 'referred_json', name: 'referred_json'},
                ...
                "ajax": {
                    "url": "quick-recharge-details/data",
                    "type": "GET"
                },
                "order": [
                    [1, "asc"]
    ...
    return {
        ...
        init: function () {
            ...
            siteObjJs.validation.formValidateInit('#create-quick-recharge-details', handleAjaxRequest);
        }
