siteObjJs.admin.configSettingsJs = function () {
    ...
    var fetchDataForEdit = function () {
        $('.portlet-body').on('click', '.edit-form-link', function () {
            ...
            var actionUrl = 'config-settings/' + settings_id + '/edit';
            $.ajax({
                url: actionUrl,
                cache: false,
                dataType: "json",
                ...
                success: function (data)
                {
                    ...
                    siteObjJs.validation.formValidateInit('#edit-config-setting', handleAjaxRequest);
                },
        ...
        $.ajax(
                {
                    ...
                    success: function (data)
                    {
                        ...
                        $("#config_category_id").select2('val', '');
        ...
        grid.init({
            ...
            dataTable: {
                ...
                "columns": [
                    ...
                    {data: 'config_category.category', name: 'category', visible: false, orderable: false},
                    {data: 'config_category_id', name: 'config_category_id', visible: false, orderable: false},
                    {data: 'description', name: 'description'},
                    {data: 'config_constant', name: 'config_constant'},
                ...
                "drawCallback": function (settings) {
                    ...
                    api.column(1, {page: 'current'}).data().each(function (group, i) {
                        if (last !== group) {
                            $(rows).eq(i).before('<tr class="group bg-blue-hoki"><td colspan="5"><b>' + group + '</b></td></tr>');
                            last = group;
                        }
    ...
    return {
        ...
        init: function () {
            ...
            siteObjJs.validation.formValidateInit('#create-config-setting', handleAjaxRequest);
        }
    };
}();
