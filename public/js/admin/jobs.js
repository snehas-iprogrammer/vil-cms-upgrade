siteObjJs.admin.jobsJs = function () {
    ...
    var initializeListener = function () {
        ...
        $('body').on("change", "#lob", function () {
         ...
         $('#jobsList').on('click', '.filter-cancel', function (e) {
        ...
        $('.portlet-body').on('click', '.edit-form-link', function () {
            ...
            $.ajax({
               ...
               //     handleDatetimePicker();
                    siteObjJs.validation.formValidateInit('#edit-jobs', handleAjaxRequest);
                },
    ...
    var handleTable = function () {
        ...
        function handleGroupAction(grid, data) {
            ...
            var actionUrl = 'jobs/group-action';
    ...
    return {
        ...
        init: function () {
          ...
          //  handleDatetimePicker();
            ...
            siteObjJs.validation.formValidateInit('#create-jobs', handleAjaxRequest);
        }
