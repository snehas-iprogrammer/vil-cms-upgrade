siteObjJs.admin.livemusicJs = function () {
    ...
    var initializeListener = function () {
        ...
        $('body').on("change", "#lob", function () {
            ...
            if(lob == 'Prepaid'){
                ...
                $("#red_hierarchy").select2('val','All');
                $("#socid").val("All SOCID");
                $("#postpaid_persona").removeAttr("disabled");
                $("#socid").attr("disabled",false);
                $("#prepaid_persona").removeAttr("disabled");
            }else{
                $("#prepaid_persona").select2('val','');
                $("#postpaid_persona").select2('val','');
                $("#postpaid_persona").attr("disabled",true);
    ...
    var fetchDataForEdit = function () {
        $('.portlet-body').on('click', '.edit-form-link', function () {
            var id = $(this).attr("id");
            var actionUrl = 'livemusic/' + id + '/edit';
            $.ajax({
                url: actionUrl,
                cache: false,
                dataType: "json",
                ...
                success: function (data)
                {
                    ...
                    siteObjJs.validation.formValidateInit('#edit-livemusic', handleAjaxRequest);
                },
        ...
        grid.init({
            ...
            dataTable: {
                ...
                "columns": [
                    ...
                    {data: 'start_date_time', name: 'start_date_time', orderable: true},
                    {data: 'end_date_time', name: 'end_date_time', orderable: false},
...
//                ]// set first column as a default sort by asc
        ...
        function handleGroupAction(grid, data) {
            ...
            var actionUrl = 'livemusic/group-action';
    ...
    return {
        ...
        init: function () {
            ...
            siteObjJs.validation.formValidateInit('#create-livemusic', handleAjaxRequest);
        }
