siteObjJs.admin.bannersJs = function () {
    ...
    var initializeListener = function () {
        ...
        $('#banners_datatable_ajax').on('click', '.filter-cancel', function (e) {
    ...
    //Identifiers
    var tableIdentifier = '#banners_datatable_ajax';
    var formIdentifier = '#admin-banner-form';
    var ajaxMessageIdentifier = $('#ajax-response-text');

    //urls
    var gridDataUrl = adminUrl + '/banner/data';
    var groupActionUrl = adminUrl + '/banner/group-action';
    var fieldCheckUrl = adminUrl + '/banner/check-avalability';
...
//init date pickers
    ...
    var handleTable = function () {
        ...
        table.on('click', '.edit', function (e) {
            e.preventDefault();
            window.location.href = adminUrl + '/banner/' + $(this).attr('data-id') + '/edit';
        });
    ...
    var checkUsername = function () {
        ...
        $('form' + formIdentifier).on('click', '#bannername1_checker', function (e) {
            validateUsername();
        });

        $('form' + formIdentifier).on('keyup blur focus', '#banner_name', function (e) {
            validateUsername();
        });
    ...
    function validateUsername() {
        var input = $('#banner_name');
        var lengthAllow = input.attr('minlength');
        var length = input.val().length;
        var pop = $('#bannername1_checker');
        var btn = $('#bannername1_checker');
        btn.attr('disabled', true);
        if (lengthAllow <= (length)) {

            input.attr('readonly', false).addClass('spinner');
            $('#bannername1_checker').removeClass('disabled');
            var form = new FormData();
            form.append('action', '');
            form.append('actionType', '');
            form.append('field', 'bannername');
