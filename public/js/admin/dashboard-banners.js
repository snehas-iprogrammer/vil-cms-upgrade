siteObjJs.admin.dashboardBannersJs = function () {
    ...
    var fetchDataForEdit = function () {
        $('.portlet-body').on('click', '.edit-form-link', function () {
            var id = $(this).attr("id");
            var actionUrl = 'dashboard-banners/' + id + '/edit';
            $.ajax({
                url: actionUrl,
                cache: false,
                dataType: "json",
                ...
                success: function (data)
                {
                    ...
                    siteObjJs.validation.formValidateInit('#edit-dashboard-banners', handleAjaxRequest);
                },
    ...
    var handleTable = function () {
        ...
        grid.init({
            ...
            dataTable: {
                ...
                "columns": [
                    ...
                    {data: 'redirection_link', name: 'redirection_link', orderable: false},
        ...
        function handleGroupAction(grid, data) {
            ...
            var actionUrl = 'dashboard-banners/group-action';
    ...
    return {
        ...
        init: function () {
            ...
            siteObjJs.validation.formValidateInit('#create-dashboard-banners', handleAjaxRequest);
        }
