siteObjJs.admin.menuGroupJs = function () {
...
// Initialize all the page-specific event listeners here.
    ...
    var initializeListener = function () {
        ...
        $('body').on('click', '.delete', function (e) {
            ...
            function handleGroupAction(grid) {
                ...
                var actionUrl = 'menu-group/' + menuGroupId;
                jQuery.ajax({
                    url: actionUrl,
                    cache: false,
                    data: {
    ...
    var fetchDataForEdit = function () {
        $('.portlet-body').on('click', '.edit-form-link', function () {
            ...
            var actionUrl = 'menu-group/' + cat_id + '/edit';
            $.ajax({
                url: actionUrl,
                cache: false,
                dataType: "json",
                ...
                success: function (data)
                {
                    ...
                    siteObjJs.validation.formValidateInit('#edit-menugroup', handleAjaxRequest);
                },
    ...
    var handleTable = function () {
        ...
        grid.init({
            ...
            dataTable: {
                ...
                "order": [
                    [2, "asc"]
                ]// set display order column as a default sort by asc
            }
        });
    ...
    return {
        ...
        init: function () {
            ...
            siteObjJs.validation.formValidateInit('#create-menugroup', handleAjaxRequest);
        }
