siteObjJs.admin.paymentBannersJs = function () {
    ...
    var fetchDataForEdit = function () {
        $('.portlet-body').on('click', '.edit-form-link', function () {
            var id = $(this).attr("id");
            var actionUrl = 'payment-banners/' + id + '/edit';
            $.ajax({
                url: actionUrl,
                cache: false,
                dataType: "json",
                ...
                success: function (data)
                {
                    ...
                    siteObjJs.validation.formValidateInit('#edit-payment-banners', handleAjaxRequest);
                },
    ...
    var handleTable = function () {
        ...
        function handleGroupAction(grid, data) {
            ...
            var actionUrl = 'payment-banners/group-action';
    ...
    return {
        ...
        init: function () {
            ...
            siteObjJs.validation.formValidateInit('#create-payment-banners', handleAjaxRequest);
        }
