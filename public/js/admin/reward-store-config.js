siteObjJs.admin.rewardStoreConfigJs = function () {
...
// Initialize all the page-specific event listeners here.
    ...
    var initializeListener = function () {
        ...
        $('body').on('click', '.delete', function (e) {
            e.preventDefault();
            var rewardStoreConfigId = $(this).attr('id');
            bootbox.confirm({
            ...
            function handleGroupAction(grid) {
                ...
                var actionUrl = 'reward-store-config/' + rewardStoreConfigId;
                jQuery.ajax({
                    url: actionUrl,
                    cache: false,
                    data: {
    ...
    var fetchDataForEdit = function () {
        $('.portlet-body').on('click', '.edit-form-link', function () {
            var rewardStoreConfigId = $(this).attr("id");
            var actionUrl = 'reward-store-config/' + rewardStoreConfigId + '/edit';
            $.ajax({
                url: actionUrl,
                cache: false,
                dataType: "json",
                ...
                success: function (data)
                {
                    ...
                    siteObjJs.validation.formValidateInit('#edit-reward-store-config', handleAjaxRequest);
                },
        ...
        grid.init({
            ...
            dataTable: {
                ...
                "columns": [
                    ...
                    {data: 'banners_json', name: 'banners_json'},
                    {data: 'partner_banners_json', name: 'partner_banners_json'},
    ...
    return {
        ...
        init: function () {
            ...
            siteObjJs.validation.formValidateInit('#create-reward-store-config', handleAjaxRequest);
        }
