siteObjJs.admin.bannerJs = function () {
    ...
    function cashback_show(){
        $("#payment_banner_details_title,#payment_banner_details,#tnc_title,#tnc_details").attr('required',true);
    }

    function cashback_hide(){
        $("#payment_banner_details_title,#payment_banner_details,#tnc_title,#tnc_details").attr('required',false);
    }
    ...
    var initializeListener = function () {
        ...
        $(".cls-cashback").hide();
        cashback_hide();
        var banner_screen = $("#banner_screen").val();
         $('#banner_screen').on("change",function () {
            banner_screen = $("#banner_screen").val();
          //  alert(banner_screen);
            if(banner_screen == 'CashbackOffersBanner'){
                $(".cls-cashback").show();
                cashback_show();
            }else{
                $(".cls-cashback").hide();
        ...
        $('.portlet-body').on('click', '.edit-form-link', function () {
            ...
            $.ajax({
                ...
                success: function (data)
                {
                    ...
                    var banner_screen = $("#edit_form").find("#banner_screen").val();
                    if(banner_screen == 'CashbackOffersBanner'){
                        $("#edit_form").find(".cls-cashback").show();
                        cashback_show();
                    }else{
                        $("#edit_form").find(".cls-cashback").hide();
                        cashback_hide();
                    }
                    
                    $("#edit_form").find("#banner_screen").change(function () {
                        banner_screen = $("#edit_form").find("#banner_screen").val();
                       // alert(banner_screen);
                        if(banner_screen == 'CashbackOffersBanner'){
                          // alert("here222");
                            $("#edit_form").find(".cls-cashback").show();
                         ...
                         $("#edit_form").find("#payment_banner_details_title,#payment_banner_details,#tnc_title,#tnc_details").attr('value',' ' );
                            $("#edit_form").find(".cls-cashback").hide();
                            cashback_hide();
                        }
                    });
