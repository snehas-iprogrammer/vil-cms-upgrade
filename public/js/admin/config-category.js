siteObjJs.admin.configCategoryJs = function () {
    ...
    var fetchDataForEdit = function () {
        $('.portlet-body').on('click', '.edit-form-link', function () {
            ...
            var actionUrl = 'config-categories/' + category_id + '/edit';
            $.ajax({
                url: actionUrl,
                cache: false,
                dataType: "json",
    ...
    return {
        ...
        init: function () {
            ...
            siteObjJs.validation.formValidateInit('#create-config-category', handleAjaxRequest);
        }
    };
}();
